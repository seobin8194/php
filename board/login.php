...
<?php
 ...
 ?>
        ...
        <p><input type="button" value="로그아웃" onclick="location.href='logout.php'"> <input type="button" value="정보수정" onclick="location.href='modify.php'"> <input type="button" value="게시판 리스트" onclick="location.href='list.php'"></p>
 <?php       
    }
?>
</body>
